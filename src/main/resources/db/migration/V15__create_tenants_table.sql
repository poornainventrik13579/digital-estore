...
VALUES
(1, 'Demo Store', 'demo@example.com', '+1-555-0100', 'https://example.com/logo.png', 'demo.example.com', 'demo', 'United States', 'USD', TRUE, 'TX123456789', 'America/New_York', 'A', 'system', 'system', NOW(), NOW()),
(2, 'Test Shop', 'test@example.com', '+1-555-0200', 'https://example.com/test-logo.png', 'test.example.com', 'test', 'Canada', 'CAD', FALSE, 'CA987654321', 'America/Toronto', 'A', 'system', 'system', NOW(), NOW());
