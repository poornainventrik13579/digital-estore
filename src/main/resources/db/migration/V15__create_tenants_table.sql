...
INSERT INTO tenants (tenant_id, shop_name, shop_email, shop_phone, shop_logo, domain_name, subdomain, country_region, store_password, base_currency, multi_currency, tax_id, timezone, status, created_by, updated_by, created, updated)
VALUES
